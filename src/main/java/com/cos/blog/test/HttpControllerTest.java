...
public class HttpControllerTest { 
	...
	public String lombokTest() {
		Member m = Member.builder().username("ssar").password("1234").email("ssar@nate.com").build(); //빌드를씀으로 생성자 매개변수 순서상관없이 수정가능
	...
	//인터넷 브라우저 요청은 무조건 get요청밖에 할수없다! 즉 post put delete다 오류!
