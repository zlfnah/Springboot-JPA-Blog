...
public class boardApiController {
	...
	//원래라면 데이터를 받을 때 컨트롤러에서 dto를 만들어서 받는게 좋다.
   //dto를 사용하지 않은 이유는
	@PostMapping("/api/board/{boardId}/reply")											                                                        //PrincipalDetail클래스에있는 유저정보필요
	public ResponseDto<Integer> replySave(@RequestBody ReplySaveRequestDto replySaveRequestDto) { //json데이터니까 무조건 requestbody
